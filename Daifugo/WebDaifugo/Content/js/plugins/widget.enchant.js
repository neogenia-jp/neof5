...
(function() {
    ...
    enchant.widget = {
        assets: [
            '/Content/imgs/listItemBg.png',
            '/Content/imgs/iconMenuBg.png',
            '/Content/imgs/button.png',
            '/Content/imgs/buttonPushed.png',
            '/Content/imgs/dialog.png',
            '/Content/imgs/navigationBar.png'
        ],
        _env: {
            // default font
            font: '12px helvetica',
