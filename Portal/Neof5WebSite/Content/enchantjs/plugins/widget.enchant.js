...
(function() {
    ...
    enchant.widget = {
        assets: [
            '/Content/enchantjs/imgs/listItemBg.png',
            '/Content/enchantjs/imgs/iconMenuBg.png',
            '/Content/enchantjs/imgs/button.png',
            '/Content/enchantjs/imgs/buttonPushed.png',
            '/Content/enchantjs/imgs/dialog.png',
            '/Content/enchantjs/imgs/navigationBar.png'
        ],
        _env: {
            // default font
            font: '12px helvetica',
